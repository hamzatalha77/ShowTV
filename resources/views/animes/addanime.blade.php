...
@section('content')
    ...
    @endif
    <form action="{{ route('animes.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
        ...
        <div class="myform">
            ...
            <div class="form-group">
                ...
                <input type="text" name="anime_name" class="metro-input">
            </div>
            <div class="form-group">
                <label>Serie Image</label>
                <input type="text" name="image_anime" class="metro-input">
            </div>
            <div class="form-group">
                <label>Image poster Anime</label>
                <input type="text" name="poster_anime" class="metro-input">
            </div>
            <div class="form-group">
                <label>Tags</label>
            ...
            <div class="form-group">
                <label>Anime Types</label>
                <select data-role="select" name="types_id[]" multiple>

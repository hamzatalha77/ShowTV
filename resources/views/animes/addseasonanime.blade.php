...
<label class="title">Add New Season for {{$anime->anime_name}}</label>
@stop

@section('content')
<form action="{{ route('anime_seasons.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off" class="fromi">
@csrf
<input  type="text" name="anime_id" value="{{$anime->id}}" class="form-control" id="user_name" hidden>
...
<h1>{{$anime->anime_name}}</h1>
    <div class="mb-3">
      ...
      <input type="text" class="form-control" name="season_name" value="{{$anime->anime_name}}" id="exampleInputEmail1" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label">Season image</label>
      <input type="text" class="form-control" name="season_image" value="{{$anime->season_image}}" id="exampleInputEmail1" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
      <label for="exampleInputPassword1" class="form-label">Season Number</label>
      <input type="text" class="form-control" name="season_number" id="exampleInputPassword1">
    </div>

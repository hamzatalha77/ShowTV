...
@section('content_header')
    <h1>All Seasons of serie: {{$anime->anime_name}}</h1>
@stop
...
<table class="table">
    ...
    <tr>
        ...
        <td>{{$season->id}}</td>
         <td> <img src="{{ $season->season_image }}" alt="" style="width:90px"></td>
            ...
            <td>
             ...
             <td>
                <form action="{{ route('anime_seasons.destroy',$season->id) }}" method="POST">
                    <a class="btn btn-success" href="{{ route('addepisodeanime', $season->id) }}">Add Episode</a>
                    <a class="btn btn-primary" href="{{ route('allepisodeanime', $season->id) }}">Show Episodes</a>
                    <a class="btn btn-info" href="{{ route('anime_episodes.show', $season->id) }}">Show</a>
                    <a class="btn btn-warning" href="{{ route('anime_seasons.edit', $season->id) }}">Edit</a>
                    @csrf
                    @method('DELETE')

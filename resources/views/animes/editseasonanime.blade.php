...
@section('content')
    ...
    @endif
    <form action="{{ route('anime_seasons.update',$season->id) }}" method="POST" enctype="multipart/form-data" style="width: 60%;position: relative;left: 20%">
        @csrf
        @method('PUT')
        <div class="myform ">
            ...
            <div class="form-group">
                ...
                <input type="text" name="season_number" value="{{ $season->season_number }}" class="metro-input">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="season_image" value="{{ $season->season_image }}" class="metro-input">
            </div>
        <div class="image-upload-one">
            <div class="center">
              <div class="form-input">
                <label for="file-ip-1">
                  <img id="file-ip-1-preview" src="{{ $season->season_image }}">
                  <button type="button" class="imgRemove" onclick="myImgRemoveFunctionOne()"></button>
                </label>
                <input type="file"  name="season_image" id="file-ip-1" accept="image/*" onchange="showPreviewOne(event);" hidden>
              </div>
            </div>
          </div>
        </div>

...
<body>
    ...
    <form action="{{ route('searchanime') }}" method="POST">
        @method('Get')
    ...
    <div class="container1 more akali" style="margin-bottom: 0px; min-height: 70%;">

        @foreach ($result as $anime)

        <div class="colling">
            <div class="poster">
                <a href="{{ route('showanime', $anime->id) }}"  title="{{  $anime->anime_name  }} شاهد الان "  class="poster__link">
                    <img class="poster__img lazy"src="{{ $anime->image_anime }}">
                    ...
                    <div class="poster__title">
                        ...
                        <div class="caption">
                            ...
                            <span>{{ $type->type }}</span>
                            @endforeach
                            <span> <i class="fas fa-star" style="color: #FEC107"></i>&nbsp;{{ $anime->imdb }}</span>
                        </div>
                    </div>
                </a>
            </div>
...
@endforeach
    ...
    {{-- <div class="container1 more again" style="margin-bottom: 0px; min-height: 70%;">
        ...
        <div class="colling">
            <div class="poster">
                <a {{ route('showanime', $anime->id) }} title="{{  $anime->anime_name  }}  شاهد الان " class="poster__link">
                    <img class="poster__img lazy"src="{{ $anime->image_anime }}">
                    <div class="poster__button">
                        <i class="fas fa-play-circle fa-4x"></i>
                    </div>
...
{{ $result->links('telfazy/pagination') }}

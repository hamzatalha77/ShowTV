...
<head>
    ...
    <link rel="stylesheet" href="/css/episode anime.css">

    <title>Telfazy |  {{ $season->season_name}} {{ $episode->episode_name }} {{ $anime->anime_name }} انمي </title>
</head>
<body onload="myFunction()">
    ...
    <section>
        ...
        <div class="adb">
            <span><p>{{  $anime->anime_name }}</p></span>
            </div>


    <div class="adb1">
<label class="titles"> {{ $season->season_name}} {{ $episode->episode_name }}</label>
    <div class="main">
    ...
    <div class="watching">
        <div class="streaming">
            <div class="boxx1">
                    ...
                    <a class="link-server" data-link="https://cloudvideo.tv/emb.html?ox59yv2mf0yw=thumb.cloudvideo.tv/108/01/00582/ox59yv2mf0yw_xt"> سيرفر المشاهدة 1</a>
                    <a class="link-server" data-link="https://www.youtube.com/embed/o8qk7Ce-12E"> سيرفر المشاهدة 2</a>
                    <a class="link-server" data-link="https://vedbom.org/embed-4ir7isgivyxn.html"> سيرفر المشاهدة 3</a>
                    <a class="link-server" data-link="//ok.ru/videoembed/2480160180961">تحميل سيرفر 1</a>
            ...
            <div class="boxx3">
                ...
                <a href="{{ route('anime_seasons.show', $episode['id']) }}" id="{{$episode['id']}}">{{ $episode->episode_name }}</a>
                @endforeach

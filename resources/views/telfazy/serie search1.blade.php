...
<link rel="stylesheet" href="/css/navbar2.css">
    ...
    <title>Telfazy | {{ $serieclasse }}</title>
</head>
<body>
    ...
    <form action="{{ route('lookingserie') }}" method="GET">
        <div class="advanced-search zed">
            ...
            <div class="col-77 col-m-5 text-col">
                ...
                <input name="serieclass" value="{{ $serieclasse }}" hidden/>
              </div>

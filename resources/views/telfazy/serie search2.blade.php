...
<link rel="stylesheet" href="/css/navbar2.css">
    ...
    <title>Telfazy | {{ $serieclass2 }}</title>
</head>
<body>
    ...
    <form action="{{ route('lookingserie') }}" method="POST">
        @method('Get')
        <div class="advanced-search">
            ...
            <div class="col-77 col-m-5 text-col">
                ...
                <input name="serieclass" value="{{ $serieclass2 }}" hidden/>
              </div>
            <div class="form-ui small col-77 col-m-7 row77 gutter-small">
                <div class="col-77 col-s-6 col-m-3 dd">
                    <select name="cars" id="cars">
                        @foreach ($genre as $data3)
                      <option value="{{ $data3->genre }}"> {{ $data3->genre }}</option>
                @endforeach
                      </select>
                </div>
            <div class="col-77 col-s-6 col-m-3 dd">
